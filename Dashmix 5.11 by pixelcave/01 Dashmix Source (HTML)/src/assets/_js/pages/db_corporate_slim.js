...
class DbCorporateSlim {
  ...
  static initCorporateChartJS() {
    ...
    // Chart Containers
    let chartCorporateSlimProjectsCon = document.getElementById(
      "js-chartjs-corporate-slim-projects"
    );
    let chartCorporateSlimTicketsCon = document.getElementById(
      "js-chartjs-corporate-slim-tickets"
    );
