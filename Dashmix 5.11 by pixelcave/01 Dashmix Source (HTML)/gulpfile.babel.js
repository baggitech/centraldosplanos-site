...
const files = {
  ...
  src: {
    ...
    js: {
      ...
      // JS Pages files
      pages: [path.src.js + "pages/**/*.min.js"],
    },
  },
  build: {
    ...
    plugins: {
      ...
      "ckeditor5-inline": {
        ...
        src: [
          ...
          "!node_modules/@ckeditor/ckeditor5-build-inline/package.json",
        ],
      ...
      "ion-rangeslider": {
        ...
        src: [
          ...
          "node_modules/ion-rangeslider/**/*.png",
        ],
      ...
      datatables: {
        ...
        src: [
          ...
          "node_modules/datatables.net/js/**/*.mjs",
        ],
      ...
      "datatables-bs5": {
        ...
        src: [
          ...
          "node_modules/datatables.net-bs5/**/*.mjs",
        ],
      ...
      "datatables-responsive": {
        ...
        src: [
          "node_modules/datatables.net-responsive/**/*.css",
          "node_modules/datatables.net-responsive/**/*.js",
          "node_modules/datatables.net-responsive/**/*.mjs",
        ],
      ...
      "datatables-responsive-bs5": {
        ...
        src: [
          ...
          "node_modules/datatables.net-responsive-bs5/**/*.mjs",
        ],
      ...
      "datatables-buttons": {
        ...
        src: [
          ...
          "node_modules/datatables.net-buttons/js/**/*.mjs",
        ],
      ...
      "datatables-buttons-bs5": {
        ...
        src: [
          ...
          "node_modules/datatables.net-buttons-bs5/**/*.mjs",
        ],
...
function depUpdate(depName, depData) {
  deleteAsync(depData.base).then(() => {
    if (depData.min) {
      return gulp
        .src(depData.src, { encoding: false })
...
gulp.task("css-scss-main", () => {
  return gulp
    ...
    .pipe(sass({ style: "expanded", precision: 6 }).on("error", sass.logError))
...
gulp.task("build-copy", () => {
  return gulp
    .src(files.build.copy, { encoding: false, base: path.dir.src })
...
gulp.task(
  "dep-update",
  gulp.series("dep-scss", "dep-fonts", "dep-js-libraries", "dep-js-plugins")
);
...
gulp.task("js", gulp.series(gulp.parallel("js-es6-main", "js-es6-pages")));
...
gulp.task("watch-es6-pages-dev", () => {
  return gulp.watch(
    files.watch.es6.pages,
    gulp.series("js-es6-pages-dev", "js-es6-pages")
  );
});
...
gulp.task(
  "watch-dev",
  gulp.parallel("watch-scss", "watch-es6-main-dev", "watch-es6-pages-dev")
);
gulp.task(
  "watch",
  gulp.parallel("watch-scss", "watch-es6-main", "watch-es6-pages")
);
