...
class pageDashboardv1 {
  ...
  static initChartsMain() {
    ...
    for (let i = 0; i < 30; i++) {
      chartMainDataMonthLabels[i] =
        i === 29 ? "1 day ago" : 30 - i + " days ago";
    }
    ...
    chartMainDataMonth = {
      ...
      datasets: [
        ...
        },
        {
          ...
          pointHoverBorderColor: "rgba(6, 101, 208, .2)",
          data: [
            210, 150, 90, 220, 150, 216, 143, 150, 136, 150, 210, 150, 90, 220,
            150, 216, 240, 230, 136, 150, 210, 150, 90, 220, 150, 216, 143, 150,
            240, 230,
          ],
        },
      ],
